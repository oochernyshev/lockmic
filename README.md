...
**Owner:** [WIXEE.AI](https://wixee.ai) · **License:** [MIT](./LICENSE) · **Version:** 1.4.27
...
- Re-applies mute every 2 seconds while muted (device switch, Meet, drivers)
...
# → build/dist/LockMic-1.4.27.zip (+ .dmg, sha256)
```
